...
ReactDOM.createRoot(document.getElementById('root')).render(
  <>
    ...
    <div className='flex md:mt-3'>
      ...
      <div className='pl-3 py-3 md:bg-[#121212] md:w-full md:h-[50rem] md:mx-3 md:rounded-xl md:pl-6'>
        <Barra_superior />
        ...
        <div className='flex flex-col gap-12 md:gap-32'>
          ...
          <div className='flex flex-col gap-10 md:flex md:flex-row justify-between'>
            <Info />
          </div>
        </div>
      </div>
